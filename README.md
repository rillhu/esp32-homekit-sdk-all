...
The `esp32 homekit sdk` is using esp-idf libraries and build. Please download ESP-IDF and the corresponding compiling tools.

- ESP-IDF

  - Based on[ESP-IDF Release v4.3](https://github.com/espressif/esp-idf/releases/tag/v4.3), Documentation  is available at https://docs.espressif.com/projects/esp-idf/en/v4.3/
  - This archive can also be downloaded from Espressif's download server: https://dl.espressif.com/dl/esp-idf/releases/esp-idf-v4.3.zip

- Compile tool

  https://dl.espressif.com/dl/esp-idf/?idf=4.3

  Note: using offline installer and select esp-idf v4.3.
  
- Build

  - if there is build error, run below command first：

    `idf.py fullclean`

  - [espressif/idf-installer: ESP IDF Windows Installer (github.com)](https://github.com/espressif/idf-installer)

  - If you have multiple ESP-IDF directories on the computer.
